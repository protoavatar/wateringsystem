    ...
    switch (e.data.substr(2, 3)) {
        case "PRG":
            ...
            for (let i = 0; i <= 6; i++) {
                ...
                } else { document.getElementById("D" + i).hidden = false; }
            }
...
document.getElementById("submit").addEventListener("click", function (event) {
    ...
    console.log("<#PRG#" + "R" + Riego + "E-" + Estado + "R" + Riego + "H-" + Hora + "R" + Riego + "T-" + Tiempo + "R" + Riego + "D-" + Dias + ">");
    connection.send("<#PRG#" + "R" + Riego + "E-" + Estado + "R" + Riego + "H-" + Hora + "R" + Riego + "T-" + Tiempo + "R" + Riego + "D-" + Dias + ">");
...
function Dia(numero) {
    ...
    Dias = ""
    if (Days[numero] === "0") {
        Dias = Days.substr(0, numero) + (numero + 1).toString() + Days.substr(numero + 1);
